...
public abstract class EntityBase
    implements java.io.Serializable, Cloneable, Comparable<EntityBase> {
  ...
  public long getDelay() {
    if (delay == 0) return ConfigUtil.combined().getInt("db.writer.delay");
    return delay;
  }
  ...
  public boolean getPersisted() {
    //  if (version == null)
    //    return 0;
    if (originalEntity != null) return originalEntity.persisted;
    return persisted;
  }
  ...
  public synchronized void setVersion(long version) {
    ...
    if (this.originalEntity != null) this.originalEntity.version = version;
  }
  ...
  public synchronized void setPersisted(Boolean persisted) {
    ...
    if (this.originalEntity != null) this.originalEntity.persisted = persisted;
  ...
  public synchronized void setRevision(int revision) {
    ...
    if (this.originalEntity != null) this.originalEntity.revision = revision;
  }
  ...
  public boolean equals(Object o) {
    ...
    // Need to check these are not null as assinged when persisted so might not yet be present when
  ...
  private void ensureUuid() {
    if (uuid == null) setUuid(UUID.randomUUID());
    // id = UUID.randomUUID();
