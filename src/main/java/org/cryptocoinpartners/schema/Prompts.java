...
public class Prompts {
	...
	public static final Prompt THIS_WEEK = prompt("THISWEEK", 1, 0.01, null, 1, 0.01, 20, FeeMethod.PercentagePerUnitOpening, 0.0003, 0.0003,
			FeeMethod.PercentagePerUnitOpening, FeeMethod.PercentagePerUnitOpening);
	public static final Prompt NEXT_WEEK = prompt("NEXTWEEK", 1, 0.01, null, 1, 0.01, 20, FeeMethod.PercentagePerUnitOpening, 0.0003, 0.0003,
			FeeMethod.PercentagePerUnitOpening, FeeMethod.PercentagePerUnitOpening);
	public static final Prompt MONTH = prompt("MONTH", 1, 0.01, null, 1, 0.01, 20, FeeMethod.PercentagePerUnitOpening, 0.0003, 0.0003,
			FeeMethod.PercentagePerUnitOpening, FeeMethod.PercentagePerUnitOpening);
	public static final Prompt QUARTER = prompt("QUARTER", 1, 0.01, null, 1, 0.01, 20, FeeMethod.PercentagePerUnitOpening, 0.0003, 0.0003,
			FeeMethod.PercentagePerUnitOpening, FeeMethod.PercentagePerUnitOpening);
