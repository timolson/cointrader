...
public class Prompt extends EntityBase {
  ...
  static Prompt forSymbolOrCreate(String symbol, double tickValue, double tickSize, String currency, double volumeBasis, double priceBasis,
      int margin, FeeMethod marginMethod, double makerFeeRate, double takerFeeRate, FeeMethod feeMethod, FeeMethod marginFeeMethod) {
    try {
  ...
  static Prompt forSymbolOrCreate(String symbol, double tickValue, double tickSize, double volumeBasis, double priceBasis, int margin,
    ...
    try {
      ...
      final Prompt prompt = new Prompt(symbol, tickValue, tickSize, volumeBasis, priceBasis, margin, marginMethod, makerfeeRate, takerfeeRate,
