...
public class Exchanges {
  ...
  public static final Exchange BITFINEX = Exchange.forSymbolOrCreate("BITFINEX", 3, 0.001, 0.002, 0.00000001, 0.01, FeeMethod.PercentagePerUnit,
      0.0003, FeeMethod.PercentagePerUnit, true);
  public static final Exchange POLONIEX = Exchange.forSymbolOrCreate("POLONIEX", 3, 0.0015, 0.0025, 0, 0.01, FeeMethod.PercentagePerUnit, 0.25,
  ...
  public static final Exchange CAMPBX = Exchange.forSymbolOrCreate("CAMPBX", 2, 0.002, 0.0025, 0, 0.01, FeeMethod.PercentagePerUnit, 0.25,
      FeeMethod.PercentagePerUnit, true);
  ...
  public static final Exchange OKCOIN = Exchange.forSymbolOrCreate("OKCOIN", 1, 0.002, 0.002, 0, 0.01, FeeMethod.PercentagePerUnit, 0.25,
  ...
  public static final Exchange OKCOIN_THISWEEK = Exchange.forSymbolOrCreate("OKCOIN_THISWEEK", 1, 0.002, 0.002, 0, 0, FeeMethod.PercentagePerUnit,
      0.25, FeeMethod.PercentagePerUnit, false);
