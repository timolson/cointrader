...
public class Exchanges {
	...
	public static final Exchange BITFINEX = Exchange.forSymbolOrCreate("BITFINEX", 3, 0.001, 0.002, 0.00000001, 0.01, FeeMethod.PercentagePerUnit, 0.0003, 0.01,
	...
	public static final Exchange OKCOIN_THISWEEK = Exchange.forSymbolOrCreate("OKCOIN_THISWEEK", 1, 0.002, 0.002, 0, 0, FeeMethod.PercentagePerUnit, 0.25, 0,
			FeeMethod.PercentagePerUnit, false);
	public static final Exchange OKCOIN_QUARTER = Exchange.forSymbolOrCreate("OKCOIN_QUARTER", 1, 0.002, 0.002, 0, 0, FeeMethod.PercentagePerUnit, 0.25, 0,
			FeeMethod.PercentagePerUnit, false);
	public static final Exchange OKCOIN_NEXTWEEK = Exchange.forSymbolOrCreate("OKCOIN_NEXTWEEK", 1, 0.002, 0.002, 0, 0, FeeMethod.PercentagePerUnit, 0.25, 0,
			FeeMethod.PercentagePerUnit, false);
	public static final Exchange KRAKEN = Exchange.forSymbolOrCreate("KRAKEN", 3, 0.0016, 0.0026, 0.00000001, 0.01, FeeMethod.PercentagePerUnit, 0.0003, 0,
			FeeMethod.PercentagePerUnit, true);
