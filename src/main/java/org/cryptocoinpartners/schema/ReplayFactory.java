...
public interface ReplayFactory {
  ...
  Replay between(@Assisted("startTime") Instant start, @Assisted("endTime") Instant end,
      @Assisted("orderByTimeReceived") boolean orderByTimeReceived, Semaphore semaphore, @Assisted("useRandomData") boolean useRandomData,
