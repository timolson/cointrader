...
public interface PortfolioService {
  ...
  /**
   * returns all Positions in all Exchanges. NOTE: if you have open orders, you will not be able to
   * trade all the Positions returned by this method. Use getTradeablePositions() instead.
   */
  @Nullable
  ...
  /**
   * returns all Postions for the given Exchange. NOTE: if you have open orders, you will not be
   * able to trade all the Positions returned by this method. Use getTradeablePositions() instead.
   */
  @Nullable
