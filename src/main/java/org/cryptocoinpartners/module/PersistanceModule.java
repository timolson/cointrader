...
import org.cryptocoinpartners.schema.HeikinAshiBarFactory;
...
public class PersistanceModule extends AbstractModule {
  ...
  // private static final ThreadLocal<EntityManager> ENTITY_MANAGER_CACHE = new
  ...
  public void configure() {
    ...
    // ConfigUtil.combined().getString("db.driver"));
    ...
    // ConfigUtil.combined().getString("db.username"));
    //        properties.put("hibernate.connection.password",
    // ConfigUtil.combined().getString("db.password"));
    ...
    // ConfigUtil.combined().getString("db.pool.size"));
    //        properties.put("hibernate.c3p0.acquire_increment",
    // ConfigUtil.combined().getString("db.pool.growth"));
    ...
    */
    ...
    install(new FactoryModuleBuilder().build(HeikinAshiBarFactory.class));
    install(new FactoryModuleBuilder().build(BalanceFactory.class));
    // .build(SpecificOrderFactory.class));
    // install(new FactoryModuleBuilder().implement(Serializable.class,
    // GeneralOrder.class).build(GeneralOrderFactory.class));
  ...
  //
  //        //   createMode = "update";
  //              return Persistence.createEntityManagerFactory("org.cryptocoinpartners.schema",
  // properties);
  //    }
