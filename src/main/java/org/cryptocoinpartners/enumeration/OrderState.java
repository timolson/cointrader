...
public enum OrderState {
    ...
    TRIGGER,
    /** 2 Indicates that a specifc order has is awaiting a trigger before being sent to exchange.  Subsequent states may be: PLACED, CANCELLING, EXPIRED, REJECTED */
    ROUTED,
    /** 3 Indicates that a specifc order has is failed to be placed on exhcnage but no exchange error retured .  Subsequent states may be: PLACED, CANCELLING, EXPIRED, REJECTED */
    ERROR,
    ...
    CANCELLED,
    /** 8 The Order cannot be filled as specified.  This is a terminal state.  */
    REJECTED,
    /** 9 If the cancellation was due to expiry, this is the terminal state instead of CANCELLED */
    EXPIRED,
